...
#define BOARD_INFO_NAME "DexArm 3.2" // redefined?
...
// Limit Switches
//
#define X_MIN_PIN          PD4//PB10
//#define X_MAX_PIN          PE15
#define Y_MIN_PIN          PB6//PE12
//#define Y_MAX_PIN          PE10
#define Z_MIN_PIN          PE8//PG8
...
// Steppers
//
#define X_STEP_PIN         PD1//PE9
#define X_DIR_PIN          PD0//PF1
#define X_ENABLE_PIN       PC12//PF2
#ifndef X_CS_PIN
  #define X_CS_PIN         PA15
#endif

#define Y_STEP_PIN         PD6//PE11
#define Y_DIR_PIN          PD5//PE8
#define Y_ENABLE_PIN       PB7//PD7
 #ifndef Y_CS_PIN
  #define Y_CS_PIN         PF8
#endif

#define Z_STEP_PIN         PA4//PE13
#define Z_DIR_PIN          PA5//PC2
#define Z_ENABLE_PIN       PE9//PC0
#ifndef Z_CS_PIN
  #define Z_CS_PIN         PF10
#endif

#define E0_STEP_PIN        PE13//PE14
#define E0_DIR_PIN         PE14//PA0
#define E0_ENABLE_PIN      PE15//PC3
#ifndef E0_CS_PIN
...
//
  ...
  // Software serial
  //
  #define X_SERIAL_TX_PIN  PD2//PE4
  #define X_SERIAL_RX_PIN  PD3//PC13

  #define Y_SERIAL_TX_PIN  PD7//PE2
  #define Y_SERIAL_RX_PIN  PB3//PE3

  #define Z_SERIAL_TX_PIN  PA6//PE0
  #define Z_SERIAL_RX_PIN  PA7//PE1

  #define E0_SERIAL_TX_PIN PE11//PD2
  #define E0_SERIAL_RX_PIN PE12//PD4
...
#define TEMP_BED_PIN       PF5  // T0 <-> Bed
...
#define HEATER_2_PIN       PB1  // Heater1
